...
static const _Cmd_type_support_symbol_names_t _Cmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, palletrone_interfaces, msg, Cmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, palletrone_interfaces, msg, Cmd)),
  }
};
...
{
  return &::palletrone_interfaces::msg::rosidl_typesupport_cpp::Cmd_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, palletrone_interfaces, msg, Cmd)() {
  return get_message_type_support_handle<palletrone_interfaces::msg::Cmd>();
}
