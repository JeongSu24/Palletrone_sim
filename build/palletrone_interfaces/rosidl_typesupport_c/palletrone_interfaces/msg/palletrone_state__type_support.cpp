...
static const _PalletroneState_type_support_symbol_names_t _PalletroneState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, palletrone_interfaces, msg, PalletroneState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, palletrone_interfaces, msg, PalletroneState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, palletrone_interfaces, msg, PalletroneState)() {
  return &::palletrone_interfaces::msg::rosidl_typesupport_c::PalletroneState_message_type_support_handle;
}
