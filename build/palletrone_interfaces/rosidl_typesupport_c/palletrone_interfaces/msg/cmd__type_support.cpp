...
static const _Cmd_type_support_symbol_names_t _Cmd_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, palletrone_interfaces, msg, Cmd)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, palletrone_interfaces, msg, Cmd)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, palletrone_interfaces, msg, Cmd)() {
  return &::palletrone_interfaces::msg::rosidl_typesupport_c::Cmd_message_type_support_handle;
}
