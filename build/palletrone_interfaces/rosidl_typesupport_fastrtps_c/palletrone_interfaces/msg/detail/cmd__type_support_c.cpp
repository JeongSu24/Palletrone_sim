...
#include "palletrone_interfaces/msg/detail/cmd__rosidl_typesupport_fastrtps_c.h"
...
using _Cmd__ros_msg_type = palletrone_interfaces__msg__Cmd;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    size_t size = 3;
    auto array_ptr = ros_message->pos_cmd;
...
size_t get_serialized_size_palletrone_interfaces__msg__Cmd(
  const void * untyped_ros_message,
...
static uint32_t _Cmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_palletrone_interfaces__msg__Cmd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_palletrone_interfaces
size_t max_serialized_size_palletrone_interfaces__msg__Cmd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = palletrone_interfaces__msg__Cmd;
    is_plain =
      (
...
static size_t _Cmd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_palletrone_interfaces__msg__Cmd(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, palletrone_interfaces, msg, Cmd)() {
