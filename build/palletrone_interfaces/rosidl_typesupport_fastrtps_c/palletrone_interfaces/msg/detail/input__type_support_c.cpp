...
#include "palletrone_interfaces/msg/detail/input__rosidl_typesupport_fastrtps_c.h"
...
using _Input__ros_msg_type = palletrone_interfaces__msg__Input;
...
size_t get_serialized_size_palletrone_interfaces__msg__Input(
  const void * untyped_ros_message,
...
static uint32_t _Input__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_palletrone_interfaces__msg__Input(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_palletrone_interfaces
size_t max_serialized_size_palletrone_interfaces__msg__Input(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = palletrone_interfaces__msg__Input;
    is_plain =
      (
      offsetof(DataType, u) +
      last_member_size
...
static size_t _Input__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_palletrone_interfaces__msg__Input(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, palletrone_interfaces, msg, Input)() {
