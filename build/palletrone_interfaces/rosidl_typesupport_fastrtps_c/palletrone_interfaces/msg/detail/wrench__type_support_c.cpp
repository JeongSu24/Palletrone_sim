...
#include "palletrone_interfaces/msg/detail/wrench__rosidl_typesupport_fastrtps_c.h"
...
using _Wrench__ros_msg_type = palletrone_interfaces__msg__Wrench;
...
size_t get_serialized_size_palletrone_interfaces__msg__Wrench(
  const void * untyped_ros_message,
...
static uint32_t _Wrench__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_palletrone_interfaces__msg__Wrench(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_palletrone_interfaces
size_t max_serialized_size_palletrone_interfaces__msg__Wrench(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = palletrone_interfaces__msg__Wrench;
    is_plain =
      (
...
static size_t _Wrench__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_palletrone_interfaces__msg__Wrench(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, palletrone_interfaces, msg, Wrench)() {
