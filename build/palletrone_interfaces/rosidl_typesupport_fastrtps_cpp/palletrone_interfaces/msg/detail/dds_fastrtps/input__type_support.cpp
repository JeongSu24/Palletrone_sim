...
#include "palletrone_interfaces/msg/detail/input__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const palletrone_interfaces::msg::Input & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  palletrone_interfaces::msg::Input & ros_message)
{
  // Member: u
  {
    cdr >> ros_message.u;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = palletrone_interfaces::msg::Input;
    is_plain =
      (
      offsetof(DataType, u) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const palletrone_interfaces::msg::Input *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<palletrone_interfaces::msg::Input *>(
    untyped_ros_message);
...
{
  return &palletrone_interfaces::msg::typesupport_fastrtps_cpp::_Input__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, palletrone_interfaces, msg, Input)() {
  return &palletrone_interfaces::msg::typesupport_fastrtps_cpp::_Input__handle;
}
