...
#include "palletrone_interfaces/msg/detail/wrench__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const palletrone_interfaces::msg::Wrench & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  palletrone_interfaces::msg::Wrench & ros_message)
{
  // Member: moment
  {
    cdr >> ros_message.moment;
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 3;
    size_t item_size = sizeof(ros_message.moment[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = palletrone_interfaces::msg::Wrench;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const palletrone_interfaces::msg::Wrench *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<palletrone_interfaces::msg::Wrench *>(
    untyped_ros_message);
...
{
  return &palletrone_interfaces::msg::typesupport_fastrtps_cpp::_Wrench__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, palletrone_interfaces, msg, Wrench)() {
  return &palletrone_interfaces::msg::typesupport_fastrtps_cpp::_Wrench__handle;
}
